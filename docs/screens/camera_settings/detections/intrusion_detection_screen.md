...
| INTRUDE-004 | Refresh preview button | TextButton.icon | re-renders the preview (simulated ~600ms delay with a spinner in place of the icon); no real camera snapshot fetch exists yet |
