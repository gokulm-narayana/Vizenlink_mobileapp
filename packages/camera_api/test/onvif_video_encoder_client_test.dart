...
void main() {
  // Shared CameraConnection.host across this file — without this the process-lifetime endpoint
  // cache would leak state between otherwise-independent test cases, same convention
  // mask_client_test.dart/osd_client_test.dart already establish.
  setUp(OnvifVideoEncoderClient.debugClearCaches);
